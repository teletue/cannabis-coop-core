        ...
        {articles.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {articles.map((article) => (
              ...
              >
                {/* Hero Placeholder */}
                <div className="aspect-video bg-[#F7F5F0] flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-12 h-12 mx-auto mb-2 rounded-full bg-[#9CAF88]/20 flex items-center justify-center">
